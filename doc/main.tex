...
\subsubsection{Sales Exploration Figures}
    ...
    \end{figure}
    Here it is clear that CA has the most products, this could just be a result of it having more stores.
    \begin{figure}[H]
    \centering
    ...
    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Time Series Decomposition"}}
    \end{figure}
    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Sales in different years"}}
    \end{figure}
    \begin{figure}[H]
        \centering
    ...
    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Total Sales per month"}}
    \end{figure}
    March has the highest total sales, which is surprising as it comes $2_{nd}$, after February, according to the number on events happening in it.
    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Total Sales per day in the month"}}
    \end{figure}
    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Total Sales for Each Event"}}
    \end{figure}
    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Total Sales for Each EventCategory"}}
    \end{figure}
    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Monthly sales in each state"}}
    \end{figure}
    So the absolute month with the maximum sales for each state:
    \begin{itemize}
        \item California: \date(August, 2015)
        \item Texas: \date(August, 2013)
        \item Wisconsin: \date( March, 2016)
    \end{itemize}
    Over the years, the month with the maximum sales in each state was the same as the one with the maximum total sales, March.
    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Per Month sales in each state"}}
    \end{figure}

    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Monthly sales for each category"}}
    \end{figure}
    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Per Month sales for each category"}}
    \end{figure}
    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Monthly sales for each department"}}
    \end{figure}
    \begin{figure}[H]
        \centering
            \includegraphics[width=\textwidth]{{"Per Month sales for each department"}}
    \end{figure}
